 ...
 */
class DynamicTest extends \Nip\Tests\AbstractTest
{
    /**
     * @var Dynamic
     */
    ...
    public function testGetVariableFromPart()
    {
        ...
        static::assertEquals(array('category_main', 'url_shop'),
            $this->object->getVariableFromPart(':category_main:url_shop'));
        static::assertEquals(array('category', 'url_product'),
            $this->object->getVariableFromPart(':category-:url_product'));
        static::assertEquals(array('category', 'url_product'),
            $this->object->getVariableFromPart(':category-:url_product-test'));
        static::assertEquals(array('category', 'url_product'),
            $this->object->getVariableFromPart('shop-:category-:url_product-test'));
        static::assertEquals(array('category_main', 'url_product'),
            $this->object->getVariableFromPart('shop-:category_main-:url_product-test'));
    }
